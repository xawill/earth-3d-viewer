// Taken from https://github.com/NASA-AMMOS/3DTilesRendererJS/blob/master/example/src/plugins/overlays/TextureOverlayMaterial.js

import { Color } from 'three';

export const TextureOverlayMaterialMixin = base =>
	class extends base {
		constructor(...args) {
			super(...args);
			this.textures = [];
